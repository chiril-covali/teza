<!-- custom-doc -->
# 🚀 **Număr Armstrong (Număr Narcisist)**
...
![Armstrong Number Example](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Narcissistic_number_370.svg/200px-Narcissistic_number_370.svg.png)

**Diagramă ASCII (Exemplu: 153):**
```text
